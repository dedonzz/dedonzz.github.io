    ...
    if (objectExists($("canvas"), "canvas")) {
        ...
        if (!circleAnimationHasPlayed) {
            ...
            $(".canvas").each(function() {
                // Init vars
                var $this = $(this),
                    /* This refers to the object, however 'this' cannot be used to obtain information from the object relatable to the canvas      											    element, because of the way that jQuery works */
                    id_name = $this.data("id"),
                    /* In order to iterate across all elements at once, an individual id tag is not referenced, instead a data element  														    is used to obtain that information*/
                    ...
                    /* 'this' is used to obtain data information regarding the data-percent the user has coded in the html 																				document. */
